...
# Configuration
# Private raw audio paths; override via env vars (see docs/REPRODUCE.md Tier 3)
_PIG_AUDIO_ROOT = os.environ.get("PIG_AUDIO_ROOT", "../../audio")
NEW_AUDIO_ROOTS = [
...
LABEL_DIR = os.environ.get("PIG_LABEL_DIR", "../../strong_labels")
...
def load_new_data():
    ...
    data = []
    abs_roots = [os.path.abspath(p) for p in NEW_AUDIO_ROOTS]
